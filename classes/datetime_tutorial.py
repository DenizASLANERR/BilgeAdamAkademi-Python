...
print(now_utc.strftime(format1))

# Convert to Madrid Time
now_madrid = now_utc.astimezone(timezone("Europe/Madrid"))
print(now_madrid.strftime(format3))

datetime.now(timezone("Europe/Madrid")).strftime(format1)
